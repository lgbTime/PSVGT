...
def fetch_sam_data_with_retry(opened_sam, reference, start, end, max_retries=5, delay=0.01):
    retries = 0
...
def process_sv(sv_line, mapfile, name, min_maq, shift=100):
    ...
    if "TRA" in info[5]:
        ...
        #if genotype[0] == "0/0":
            #genotype = breaks2GT(sampleID, bp1_sam, bp2_sam, chrome, chrome, bp1, bp2, sv_size, min_maq, "INV",shift=shift)
