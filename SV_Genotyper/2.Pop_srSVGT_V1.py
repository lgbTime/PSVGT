...
if __name__ == "__main__":
    ...
    IN.add_argument("-m", dest="maq", default=45,type=int, help="the mini mapping quality of the contigs, range from 0-60, default is 45")
    IN.add_argument("-s", dest="shift",default=25,type=int, help="breakpoints may shifting, if the shifting range is expand, the clip reads ratio to call genotype should be smaller, please check sub_svGT ratio to determine the genotype")
