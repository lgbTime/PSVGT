...
def main():
    ...
    parser.add_argument("-d", "--dtype", required=True, help="dtype, hifi/ont/pb")
    ...
    nsv_dir = os.path.join(base_dir, "NSV_lr")
    ...
    while True:
        ...
        run_cmd(f"python {PSVGT_EXE} -{args.dtype} {query_folder} -o {out_dir} -msv yes -m 45 -r {current_ref}")
